...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        expression = "operate()",
        "io.quee.ktx.radix.develop.operation.ext.runOperation"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.quee.ktx.radix.develop.operation.ext.operateRole"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.quee.ktx.radix.develop.operation.ext.runOperator"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.quee.ktx.radix.develop.operation.ext.FunctionOperation"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.quee.ktx.radix.develop.operation.ext.MapperOperation"
    ),
)
