package io.arkitik.ktx.radix.develop.operation.function

import io.arkitik.ktx.radix.develop.operation.OperationRole
import io.arkitik.ktx.radix.develop.shared.error.Error
import io.arkitik.ktx.radix.develop.shared.error.ErrorResponse
import io.arkitik.ktx.radix.develop.shared.ext.badRequest
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.arkitik.ktx.radix.develop.operation.ext.DefaultJavaXValidator"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.arkitik.ktx.radix.develop.operation.ext.JavaXValidator"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.arkitik.ktx.radix.develop.operation.ext.DefaultErrorMapper"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.arkitik.ktx.radix.develop.operation.ext.ErrorMapper"
    ),
)
