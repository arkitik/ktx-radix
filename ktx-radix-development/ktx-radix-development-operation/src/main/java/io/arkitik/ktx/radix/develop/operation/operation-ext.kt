package io.arkitik.ktx.radix.develop.operation
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        expression = "operate()",
        "io.arkitik.ktx.radix.develop.operation.ext.runOperation"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.arkitik.ktx.radix.develop.operation.ext.operateRole"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.arkitik.ktx.radix.develop.operation.ext.runOperator"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.arkitik.ktx.radix.develop.operation.ext.FunctionOperation"
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "io.arkitik.ktx.radix.develop.operation.ext.MapperOperation"
    ),
)
